...
export function Profile() {
  ...
  return (
    <div className="max-w-3xl">
      ...
      >
        {/* Header Section */}
        <div className="relative bg-gradient-to-br from-blue-600/20 via-purple-600/20 to-cyan-600/20 px-6 py-8 border-b border-neutral-700/50">
          <div className="flex gap-6 items-start">
            ...
            >
              <div className="w-24 h-24 rounded-2xl bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center shadow-lg">
                <span className="text-3xl font-bold text-white">WK</span>
              </div>
              <div className="absolute -bottom-2 -right-2 w-8 h-8 bg-green-500 rounded-full border-4 border-neutral-800" />
            </motion.div>
              ...
              >
                {highlights.map((highlight, index) => {
                  ...
                  return (
                    <div
                      key={highlight.label}
                      className={`flex items-center gap-2 px-3 py-1.5 rounded-lg ${highlight.bgColor} border border-neutral-700/30`}
                    >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {values.map((value, index) => {
                ...
                return (
                  <div
                    key={value.title}
                    className="flex gap-3 p-4 bg-neutral-900/50 rounded-xl border border-neutral-700/30"
                  >
                    <div className="flex items-center justify-center w-10 h-10 rounded-lg bg-neutral-800 text-cyan-400 flex-shrink-0">
