          ...
          {contactMethods.map((method, index) => {
            ...
            return (
              <motion.a
                ...
                className={`flex items-center gap-4 p-4 rounded-xl ${method.bgColor} ${method.hoverBg} border border-neutral-700/30 transition-all duration-200 group`}
              >
                <div
                  className={`flex items-center justify-center w-12 h-12 rounded-lg ${method.color} bg-neutral-900/50`}
                >
                ...
                <div className="flex-1">
                  ...
                  <div
                    className={`text-base font-medium ${method.color} group-hover:underline`}
                  >
                    {method.value}
                  </div>
                </div>
