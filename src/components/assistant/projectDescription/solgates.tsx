      ...
      <div className="mb-8">
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li className="text-white italic">
            Led frontend architecture and implementation for Solgates, an online streetwear platform offering authenticated apparel and accessories.
          </li>
          <li className="text-white italic">
            Built a performant, mobile-first shopping experience that serves as the primary business surface for product discovery and conversion.
          </li>
          <li className="text-white italic">
            Focused on rendering performance, UX clarity, and architectural flexibility to support evolving inventory and business needs.
          </li>
          <li className="text-white italic">
            Delivered a polished, reliable storefront that balances visual appeal with fast, intuitive shopping flows.
          </li>
        </ul>
      </div>
      ...
      <div className="">
        ...
        <TabsContent key="frontendArchitecture" value="frontendArchitecture">
          <div className="prose text-white italic max-w-none mt-4">
            ...
            <p className="mt-2">
              This structure allows new categories, collections, and UI patterns
              to be added with minimal friction.
            </p>
            ...
            <p className="mt-2">
              ...
              interactions over heavier rendering strategies that would increase
              complexity.
            </p>
          </div>
        </TabsContent>
        <TabsContent key="performance" value="performance">
          <div className="prose text-white italic max-w-none mt-4">
            ...
            <ul className="list-disc pl-6 mt-2">
              ...
              <li className="mt-2">
                Instant visual feedback for user actions (e.g., navigation, cart
                interactions).
              </li>
              <li className="mt-2">
        ...
        <TabsContent key="outcomes" value="outcomes">
          <div className="prose text-white italic max-w-none mt-4">
            ...
            <ul className="list-disc pl-6 mt-2">
              <li className="mt-2">
                Enabled fast, intuitive product discovery across categories and
                collections.
              </li>
              <li className="mt-2">
              ...
              <li className="mt-2">
                Improved perceived performance and responsiveness, particularly
                on mobile devices.
              </li>
              <li className="mt-2">
        ...
        <TabsContent key="whatIWouldImproveNext" value="whatIWouldImproveNext">
          <div className="prose text-white italic max-w-none mt-4">
            <p>
              With additional time or scale, future frontend improvements would
              include:
            </p>
            <ul className="list-disc pl-6 mt-2">
              <li className="mt-2">
