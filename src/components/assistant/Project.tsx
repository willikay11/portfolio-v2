                    ...
                    <Tabs defaultValue="overview" className="w-full mt-6">
                      ...
                      <TabsContent key="overview" value="overview">
                        <div className="prose text-neutral-600 dark:text-neutral-400 italic max-w-none mt-4">
                          <p>
                            ...
                            and communities. The product is mobile‑first, with
                            native apps providing the core interaction model,
                            while the web experience (tukai.co) serves as the
                            primary entry point for discovery and conversion.
                          </p>
                          <p className="mt-4">
                            The web frontend plays a critical role in
                            introducing the product, surfacing curated
                            experiences, and guiding users into deeper
                      ...
                      >
                        <div className="prose text-neutral-600 dark:text-neutral-400 italic max-w-none mt-4">
                          ...
                          <ul className="list-disc pl-6 mt-2">
                            <li className="mt-2">
                              <strong>Discovery-first UX:</strong> Users should
                              be able to quickly browse and understand what
                              Tukai offers without onboarding friction.
                            </li>
                            <li className="mt-2">
                              <strong>Performance expectations:</strong> First
                              impressions matter — slow loads or janky
                              interactions would directly impact conversion.
                            </li>
                            <li className="mt-2">
                              <strong>SEO & reach:</strong> The web experience
                              needed to be indexable and search-friendly to
                              support organic discovery.
                            </li>
                            <li className="mt-2">
                              <strong>Mobile-first reality:</strong> Most users
                              would ultimately engage through mobile devices and
                              native apps.
                            </li>
                            <li className="mt-2">
                              <strong>Small-team constraints:</strong> The
                              frontend needed to be maintainable and extensible
                              without heavy ongoing overhead.
                            </li>
                          </ul>
                          <p className="mt-4">
                            These constraints required careful tradeoffs between
                            richness, speed, and long-term maintainability.
                          </p>
                        </div>
                      </TabsContent>
                      <TabsContent key="myRole" value="myRole">
                        <div className="prose text-neutral-600 dark:text-neutral-400 italic max-w-none mt-4">
                          ...
                          <ul className="list-disc pl-6 mt-2">
                            <li className="mt-2">
                              Frontend technology selection and architectural
                              decisions
                            </li>
                            <li className="mt-2">
                          ...
                          <p className="mt-4">
                            I worked end-to-end on the frontend, from initial
                            design decisions through production deployment.
                          </p>
                        </div>
                      </TabsContent>
                      <TabsContent
                      ...
                      >
                        <div className="prose text-neutral-600 dark:text-neutral-400 italic max-w-none mt-4">
                          ...
                          <ul className="list-disc pl-6 mt-2">
                            <li className="mt-2">
                              Built using React with TypeScript to ensure type
                              safety and predictable component contracts.
                            </li>
                            <li className="mt-2">
                              Adopted Next.js to enable server-side rendering
                              (SSR) for SEO-critical pages while retaining
                              client-side interactivity.
                            </li>
                            <li className="mt-2">
                              Used file-based routing to keep navigation
                              explicit and easy to reason about.
                            </li>
                            <li className="mt-2">
                              <strong>Tradeoff:</strong> SSR adds complexity,
                              but the improved SEO and faster first paint
                              justified the cost for a discovery-driven product.
                            </li>
                          </ul>
                          ...
                          <p className="mt-2">
                            Component-driven design with clear separation
                            between:
                          </p>
                          <ul className="list-disc pl-6 mt-2">
                            ...
                            <li className="mt-2">
                              Reusable UI primitives aligned to a shared visual
                              language with the mobile app.
                            </li>
                          </ul>
                          <p className="mt-2">
                            Composition over inheritance to keep components
                            flexible and decoupled.
                          </p>
                          <p className="mt-2">
                            This structure allows new discovery surfaces
                            (categories, featured experiences, communities) to
                          ...
                          <ul className="list-disc pl-6 mt-2">
                            <li className="mt-2">
                              Local state scoped as tightly as possible to avoid
                              unnecessary re-renders.
                            </li>
                            <li className="mt-2">
                              Explicit handling of loading, empty, and error
                              states to improve UX resilience.
                            </li>
                            <li className="mt-2">
                              Data-fetching abstractions designed to be
                              predictable and easy to replace as backend
                              capabilities evolve.
                            </li>
                          </ul>
                        </div>
                      ...
                      <TabsContent key="performance" value="performance">
                        <div className="prose text-neutral-600 dark:text-neutral-400 italic max-w-none mt-4">
                          ...
                          <ul className="list-disc pl-6 mt-2">
                            <li className="mt-2">
                              Server-side rendering for landing and discovery
                              pages to improve time-to-first-paint.
                            </li>
                            <li className="mt-2">
                              Code splitting and lazy loading for non-critical
                              UI and routes.
                            </li>
                            <li className="mt-2">
                              Minimal JavaScript execution on landing pages to
                          ...
                          <ul className="list-disc pl-6 mt-2">
                            <li className="mt-2">
                              Responsive image loading to ensure efficient
                              delivery across device sizes.
                            </li>
                            <li className="mt-2">
                              Optimized font loading strategies to avoid layout
                              shifts.
                            </li>
                            <li className="mt-2">
                              CDN-backed static assets for consistent global
                              performance.
                            </li>
                          </ul>
                          ...
                          <ul className="list-disc pl-6 mt-2">
                            <li className="mt-2">
                              Skeleton states and progressive loading patterns
                              to maintain responsiveness.
                            </li>
                            <li className="mt-2">
                              Mobile-first layout decisions aligned with real
                              user behavior.
                            </li>
                            <li className="mt-2">
                              Fast navigation patterns that feel instant even on
                              slower networks.
                            </li>
                          </ul>

                          <p className="mt-4">
                            These efforts ensured the frontend felt fast,
                            polished, and reliable — particularly on mobile
                            devices.
                          </p>
                        </div>
                      </TabsContent>
                      <TabsContent key="outcomes" value="outcomes">
                        <div className="prose text-neutral-600 dark:text-neutral-400 italic max-w-none mt-4">
                          ...
                          <ul className="list-disc pl-6 mt-2">
                            <li className="mt-2">
                              Enabled users to discover unique places,
                              activities, and communities with minimal friction.
                            </li>
                            <li className="mt-2">
                              Established Tukai.co as a strong top-of-funnel
                              experience, effectively guiding users into the
                              native mobile app.
                            </li>
                            <li className="mt-2">
                              Improved discoverability through SEO-friendly
                              rendering and performance-focused design.
                            </li>
                            <li className="mt-2">
                              Delivered a clean, intuitive UI that communicates
                              product value quickly to first-time users.
                            </li>
                            <li className="mt-2">
                              Created a scalable frontend foundation that
                              supports rapid iteration and future feature
                              expansion.
                            </li>
                          </ul>
                          <p className="mt-4">
                            The frontend evolved from a simple landing
                            experience into a core discovery surface for the
                            product.
                          </p>
                        </div>
                      </TabsContent>
                      ...
                      >
                        <div className="prose text-neutral-600 dark:text-neutral-400 italic max-w-none mt-4">
                          ...
                          <ul className="list-disc pl-6 mt-2">
                            <li className="mt-2">
                              Formalizing a shared design system with tokens
                              used across web and mobile.
                            </li>
                            <li className="mt-2">
                              Implementing Core Web Vitals monitoring and
                            ...
                            <li className="mt-2">
                              Deeper analytics integration to drive discovery UX
                              decisions.
                            </li>
                          </ul>
                        </div>
